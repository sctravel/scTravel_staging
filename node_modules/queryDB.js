...
var searchVoucherSQL =  "select voucher.voucher_id as  id, o.order_id, o.confirmation_code , o.total_order_amount, o.order_status, " +
    ...
    " offer.offer_name,voucher.quantity from " + tableNames.orderTable + " o inner join " + tableNames.voucherTable +" voucher on " +
    ...
    " route.arrival_spot_id=arr.spot_id ";

exports.getVouchersFromCustomerInfo = function(userInfo, callback) {

    var sql = searchVoucherSQL + " where customer.customer_name=? and customer.mobile_phone= ? ";
...
exports.getVouchersFromConfirmationCode = function(confirmCode, callback) {
    var sql = searchVoucherSQL + " where o.confirmation_code= ? ";
    ...
    async.waterfall([
        ...
        function(customerId, callback2){
            ...
            var insertVoucherSQL = " insert into " + tableNames.voucherTable + " ( voucher_id, order_id, offer_id, sku_id , schedule_id, quantity, " +
                " valid_date, offer_subtotal_amount, voucher_description ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?,?) ";
            ...
            for(var i in vouchers) {
                ...
                var params=[voucherId,orderId, vouchers[i].offerId, voucher.skuId, voucher.scheduleId, voucher.quantity, voucher.validDate, voucher.offerSubtotalAmount,""];//voucher.voucherDescription];
...
exports.getCustomersFromOrderNumber = function(CustomersOrderId,callback) {
    ...
    var sql = "select C.customer_id,C.customer_name,C.mobile_phone,C.email,C.is_registered from sc_customers as C inner join sc_orders as O
    where C.customer_id = O.customer_id and  O.customer_id=?";
