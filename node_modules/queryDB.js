...
exports.getVouchersFromConfirmationCode = function(confirmCode, callback) {
    var sql = "select o.order_id, o.confirmation_code , o.total_order_amount, o.order_status, " +
        " voucher.voucher_id, voucher.offer_subtotal_amount, customer.customer_id, customer.customer_name, customer.mobile_phone, customer.email, " +
        ...
        " route.arrival_spot_id=arr.spot_id where o.confirmation_code= ? ";
