...
//password: 'travel',//process.env.MYSQL_PASS,
...
exports.validateTicket = function(confirmationCode, spotId, date, timeSlot, callback) {
    //var sql = " select order_id from "+orderTable+" where confirmation_code="+confirmationCode;

    var sqlValidate = "update "+ticketTable+" set is_valid='N', redeem_datetime=sysdate() where confirmation_code=? and spot_Id=? and valid_date=?  and time_slot=? and (is_valid='Y' or is_valid is NULL) ";
...
exports.checkInventory = function(spotId,date,time_slot,callback){
    var sqlCheckInventory = " select * from "+inventoryTable+" where spot_id=? and date=? and time_slot=?";
