...
var letter = ['1','2','3','4','5','6','7','8','9','0','A','B','C','D','E','F','G','H','I','J','K','L','M','N',
...
var generateRandomString=function(len) {
    ...
    for(var i=0;i<len;++i) {
        ...
        confirmationCode=confirmationCode+letter[randomNumber];
    }
...
exports.generateConfirmCode = generateRandomString(10);
...
exports.generateOrderId = function(customerId) {
    ...
    return dateString+customerId+letter[Math.floor(Math.random()*10)];
}