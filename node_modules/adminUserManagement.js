...
exports.addNewAccount = function(newData, username, randomKey, callback) {
    ...
    verifyUser(username, randomKey, function(err,results){
        ...
        if(results && results == "done") {
            ...
            conn.runQueryWithParams(newAccountSql,[newData.username, newData.name,newData.password/*saltAndHash(newData.password)*/], function(err,results) {
                if(err) {
                    console.error(err);
                    callback(err,null);
                    return;
...
exports.deleteAccount = function(deleteUsername, username, randomKey, callback) {
    ...
    verifyUser(username, randomKey, function(err,results){
        ...
        if(results && results == "done") {
            ...
            conn.runQueryWithParams(deleteAccountSql,[deleteUsername], function(err,results) {
                if(err) {
                    console.error(err);
                    callback(err,null);
                    return;
...
exports.updatePasswordForAdminAccount = function(updateData,username, randomKey, callback) {
    ...
    verifyUser(username, randomKey, function(err,results){
        ...
        if(results && results == "done") {
            ...
            conn.runQueryWithParams(updatePasswordSql,[updateData.password,updateData.updateUsername], function(err,results) {
                if(err) {
                    console.error(err);
                    callback(err,null);
                    return;
