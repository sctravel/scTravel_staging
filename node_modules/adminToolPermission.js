...
exports.editPermissionsForUser = function(username, randomKey, selectedUsername, permissionChanges, callback) {
    ...
    //TODO verify user with randomKey
 ...
 * @param callback     'done' / 'failed'
 */
exports.removePermissionsFromUser = function(username, randomKey, selectedUsername, toolIdList, callback) {
    ...
    if(hasError==false) {
        ...
        callback(null,'failed');
        throw new Error(" Remove user permissions for user:"+ selectedUsername+ " failed!");
    }
}