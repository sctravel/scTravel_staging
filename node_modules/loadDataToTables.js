...
var loadDataFromTxtToTable = function( tableColumnNames, tableColumnTypes, filePath, delimiter, tableName) {
    ...
    var processline = function(line) {
        ...
        connection.query( insertSql, userInput,function(err,results){console.dir(results.insertId)});
    }
...
var busScheduleColumnNames = ['route_id','bus_id','driver_id','departure_time','arrival_time','schedule_date'];
var busScheduleColumnTypes = ['NUMBER','NUMBER','NUMBER','STRING','STRING','DATE'];
