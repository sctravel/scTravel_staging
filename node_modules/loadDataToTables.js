...
var loadDataFromTxtToTable = function( tableColumnNames, tableColumnTypes, filePath, delimiter, tableName) {
    ...
    var processline = function(line) {
        ...
        connection.query( insertSql, userInput,function(err,results){console.dir(results)});
    }
...
var routesColumnNames=['route_id', 'departure_spot_id', 'arrival_spot_id', 'distance', 'route_description', 'duration_in_minutes', 'travel_time_in_minutes', 'base_price'];
var routesColumnTypes=['NUMBER','NUMBER','NUMBER','NUMBER','STRING','NUMBER','NUMBER','NUMBER'];
