...
var createTableSQL3= 'CREATE TABLE ' + tableNames.ticketTable +
    ' ( sku_id INT NOT NULL, ' +
    ' spot_id INT, ' +
    ' ticket_description VARCHAR(63),' +
    ' creation_datetime TIMESTAMP DEFAULT now(), ' +
    ' last_updated_time TIMESTAMP  DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, ' +
    // ' created_by VARCHAR(15), ' +
    ' FOREIGN KEY tickets_f_key_sku (sku_id) REFERENCES '+ tableNames.skuTable +'(sku_id) ON DELETE CASCADE  ' +
    ' )ENGINE=InnoDB DEFAULT CHARSET=utf8 ';

//Table SC_SKU_ROUTES
//auto_increment starting from 1000000 to avoid conflict id with spots table
