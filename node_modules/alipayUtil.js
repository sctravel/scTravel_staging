...
//                                   /gateway.do?body=11&notify_url=http://www.xxx.cn/create_direct_pay_by_user_jsp_utf8/notify_url.jsp&out_trade_no=20120708132324&payment_type=1&return_url=http://127.0.0.1:8080/create_direct_pay_by_user_jsp_utf8/return_url.jsp&service=create_direct_pay_by_user&show_url=http://www.xxx.com/order/myorder.jsp&subject=11&total_fee=0.01&sign=dfc1995af2ff01642a3cf6936ce0d57c&sign_type=MD5
    ...
    //请与贵网站订单系统中的唯一订单号匹配
    var out_trade_no = '20120708132320'; //req.body.orderId
    ...
    AlipayNotify.verity(params,function(result){
        if(result){
            ...
            if(trade_status=="TRADE_FINISHED"){
                console.log("trade finished, this is for paynotify");
                res.redirect("/");
                ...
                console.log("trade success, this is for paynotify");
                res.redirect("/");
                //判断该笔订单是否在商户网站中已经做过处理
                //如果没有做过处理，根据订单号（out_trade_no）在商户网站的订单系统中查到该笔订单的详细，并执行商户的业务程序
                //如果有做过处理，不执行商户的业务程序
            ...
            console.log("trade finish or success, this is for paynotify");
    ...
    AlipayNotify.verity(params,function(result){
        ...
        if(result){
            ...
            if(trade_status=="TRADE_FINISHED"){
                ...
                console.log("trade finished, this is for payreturn");
                res.redirect("/");
                //判断该笔订单是否在商户网站中已经做过处理
                //如果没有做过处理，根据订单号（out_trade_no）在商户网站的订单系统中查到该笔订单的详细，并执行商户的业务程序
                //如果有做过处理，不执行商户的业务程序
                ...
                console.log("trade success, this is for payreturn");
                res.redirect("/");
                //判断该笔订单是否在商户网站中已经做过处理
                //如果没有做过处理，根据订单号（out_trade_no）在商户网站的订单系统中查到该笔订单的详细，并执行商户的业务程序
                //如果有做过处理，不执行商户的业务程序
            ...
            console.log("trade finished or success, this is for payreturn");
            res.redirect("/");
            //——请根据您的业务逻辑来编写程序（以上代码仅作参考）——
